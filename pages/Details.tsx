...
const Details: React.FC = () => {
  ...
  return (
    <div className="max-w-[1120px] mx-auto px-4 md:px-10 lg:px-20 py-8">
      {/* Title and Share */}
      <div className="mb-6">
        <h1 className="text-[26px] font-medium text-slate-900 mb-2">{listing.title}</h1>
        <div className="flex flex-wrap items-center justify-between gap-4 text-sm font-medium underline underline-offset-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-2 h-[350px] md:h-[500px] rounded-[12px] overflow-hidden mb-12">
        ...
        <div className="hidden md:block relative group cursor-pointer">
          <img 
            ...
            onError={handleImageError}
          />
          <button className="absolute bottom-6 right-6 px-4 py-2 bg-white border border-slate-900 rounded-lg text-sm font-medium shadow-sm hover:bg-brand-50 transition-colors">Tüm fotoğrafları göster</button>
        </div>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="flex justify-between items-start pb-6 border-b border-slate-200">
             <div>
                <div className="flex items-center gap-3 mb-1">
                   <h2 className="text-[22px] font-medium text-slate-900">Mülk sahibi: {listing.sourceName}</h2>
                   <div className="flex items-center gap-2 px-2 py-1 bg-slate-50 border border-slate-200 rounded-lg">
                      ...
                      <span className="text-[10px] font-medium uppercase text-slate-600 tracking-tighter">{listing.sourceName} İlanı</span>
                   </div>
                </div>
          ...
          <div className="py-8 border-b border-slate-200 space-y-6">
            <div className="flex gap-4">
               ...
               <div>
                  <h4 className="font-medium text-slate-900">Tam donanımlı konut</h4>
            ...
            <div className="flex gap-4">
               ...
               <div>
                  <h4 className="font-medium text-slate-900">Harika konum</h4>
          ...
          <div className="py-8">
            <h3 className="text-[22px] font-medium text-slate-900 mb-4">Açıklama</h3>
            <p className="text-slate-700 leading-relaxed whitespace-pre-line text-lg">
              {listing.description}
            </p>
            <button className="mt-4 font-medium underline text-slate-900 underline-offset-4 hover:text-brand-600 transition-colors">Daha fazla oku</button>
          </div>
        </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-28 p-6 bg-white border border-slate-200 rounded-[24px] airbnb-shadow">
            <div className="flex justify-between items-end mb-6">
              <div>
                <span className="text-2xl font-medium text-brand-600">{listing.price.toLocaleString('tr-TR')} TL</span>
            ...
            <div className="border border-slate-300 rounded-xl overflow-hidden mb-4 hover:border-brand-300 transition-colors">
              <div className="grid grid-cols-2 border-b border-slate-300">
                <div className="p-3 border-r border-slate-300">
                  <p className="text-[10px] font-medium uppercase text-slate-500">GİRİŞ</p>
                  <p className="text-sm">Müsaitlik sor</p>
                </div>
                <div className="p-3">
                  <p className="text-[10px] font-medium uppercase text-slate-500">ÇIKIŞ</p>
                  <p className="text-sm">Bize ulaşın</p>
                </div>
              </div>
              <div className="p-3">
                <p className="text-[10px] font-medium uppercase text-slate-500">MİSAFİRLER / KİŞİLER</p>
                <p className="text-sm">1 kişi</p>
              </div>
            </div>

            <button className="w-full py-3.5 bg-brand-500 text-white rounded-lg font-medium text-lg mb-4 active:scale-[0.98] transition-all hover:bg-brand-600 shadow-md">İletişime Geç</button>
            ...
            <div className="space-y-3 text-sm text-slate-700">
              ...
              <div className="pt-4 mt-4 border-t border-slate-200 flex justify-between font-medium text-lg text-slate-900">
                <span>Toplam</span>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 z-[100] md:hidden flex justify-between items-center shadow-lg">
        <div>
           <p className="font-medium text-lg">{listing.price.toLocaleString('tr-TR')} TL <span className="text-sm font-normal text-slate-500">/ay</span></p>
           <p className="text-xs font-medium underline text-brand-600">Müsaitlik sor</p>
        </div>
        <a 
          href={listing.sourceUrl}
          target="_blank"
          className="bg-brand-500 text-white px-6 py-3 rounded-xl font-medium shadow-md active:scale-95 flex items-center gap-2"
        >
         ...
         <div className="max-w-[1120px] mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
               ...
               <div>
                  ...
                  <p className="text-xs text-brand-600 font-medium underline cursor-pointer">Detayları gör</p>
               </div>
            </div>
            <a 
              href={listing.sourceUrl}
              target="_blank"
              className="bg-brand-600 text-white px-10 py-3.5 rounded-xl font-medium hover:bg-brand-700 transition-all shadow-lg active:scale-95 flex items-center gap-2.5"
            >
