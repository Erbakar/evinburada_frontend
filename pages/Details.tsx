          ...
          <div className="sticky top-28 p-6 bg-white border border-slate-200 rounded-[24px] airbnb-shadow">
            ...
            <div className="border border-slate-300 rounded-xl overflow-hidden mb-4 hover:border-orange-300 transition-colors">
              <div className="grid grid-cols-2 border-b border-slate-300">
                ...
                <div className="p-3">
                  <p className="text-[10px] font-bold uppercase text-slate-500">ÇIKIŞ</p>
                  <p className="text-sm">Bize ulaşın</p>
                </div>
              </div>
              <div className="p-3">
                <p className="text-[10px] font-bold uppercase text-slate-500">MİSAFİRLER / KİŞİLER</p>
            ...
            <div className="space-y-3 text-sm text-slate-700">
              ...
              <div className="pt-4 mt-4 border-t border-slate-200 flex justify-between font-bold text-lg text-slate-900">
                <span>Toplam</span>
