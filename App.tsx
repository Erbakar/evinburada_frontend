  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-white">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-100 sticky top-0 z-[100]">
        <div className="max-w-[1760px] mx-auto px-6 md:px-10 lg:px-20 h-20 flex items-center justify-between">
          ...
          <div 
            ...
            className="hidden md:flex items-center gap-6 px-6 py-2.5 border border-slate-200 rounded-full shadow-sm hover:shadow-md transition-all cursor-pointer bg-white"
          >
            <span className="text-[11px] font-black uppercase tracking-widest text-slate-700">İlan Tipi</span>
            <div className="w-[1px] h-4 bg-slate-200"></div>
            <span className="text-[11px] font-black uppercase tracking-widest text-slate-700">Konum</span>
            <div className="w-[1px] h-4 bg-slate-200"></div>
            <div className="flex items-center gap-3">
              <span className="text-[11px] font-black uppercase tracking-widest text-slate-400">Filtrele</span>
          ...
          <div className="flex items-center gap-6">
            <span className="hidden lg:block text-xs font-black uppercase tracking-widest text-slate-600 hover:text-orange-600 cursor-pointer transition-colors">İlan Verin</span>
            <div className="flex items-center gap-3 p-1 border border-slate-200 rounded-full hover:shadow-md transition-shadow cursor-pointer bg-slate-50">
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-white rounded-[40px] shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
            <div className="p-8 border-b border-slate-100 flex items-center justify-between">
              ...
              <h2 className="text-lg font-black tracking-tighter uppercase">Filtre Seçenekleri</h2>
            ...
            <div className="flex-grow overflow-y-auto p-10 space-y-12 hide-scrollbar">
              <section className="space-y-4">
                <h3 className="text-sm font-black uppercase tracking-widest text-slate-400">İlan Tipi</h3>
                <div className="grid grid-cols-3 gap-3">
                  {['Satılık', 'Kiralık', 'Günlük Kiralık'].map(type => (
                    <button 
                      key={type}
                      onClick={() => setModalFilters(p => ({...p, dealType: type as any}))}
                      className={`py-4 rounded-2xl border-2 font-black text-xs uppercase tracking-widest transition-all ${modalFilters.dealType === type ? 'border-orange-500 bg-orange-50 text-orange-600' : 'border-slate-100 hover:border-orange-200 text-slate-600'}`}
                    >
                      {type}
                    </button>
                  ))}
              ...
              <section className="space-y-4">
                <h3 className="text-sm font-black uppercase tracking-widest text-slate-400">Konum Tercihi</h3>
            ...
            <div className="p-8 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-6">
              <button onClick={() => setIsFilterModalOpen(false)} className="text-xs font-black uppercase tracking-widest text-slate-400">Vazgeç</button>
      ...
      <footer className="bg-white border-t border-slate-100 py-12">
        <div className="max-w-[1760px] mx-auto px-6 md:px-10 lg:px-20 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 bg-orange-500 rounded-lg flex items-center justify-center text-white">
               <svg viewBox="0 0 32 32" className="w-4 h-4 fill-current"><path d="M16 1L2 12v17h28V12L16 1zm11 26h-6v-8h-10v8H5V13.2l11-8.58 11 8.58V27z"/></svg>
            </div>
            <span className="text-sm font-black text-slate-900 tracking-tighter">evinburada ai</span>
            <span className="text-xs text-slate-400 font-bold ml-4">© 2024 Tüm hakları saklıdır.</span>
          </div>

          <div className="flex items-center gap-8 text-[11px] font-black uppercase tracking-widest text-slate-400">
             <span className="hover:text-orange-600 cursor-pointer transition-colors">Hakkımızda</span>
             ...
             <div className="flex gap-4 ml-4">
                <div className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-orange-50 hover:border-orange-200 transition-colors cursor-pointer group">
                   <div className="w-3 h-3 bg-slate-300 group-hover:bg-orange-400 rounded-sm"></div>
                </div>
                <div className="w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center hover:bg-orange-50 hover:border-orange-200 transition-colors cursor-pointer group">
                   <div className="w-3 h-3 bg-slate-300 group-hover:bg-orange-400 rounded-sm"></div>
                </div>
